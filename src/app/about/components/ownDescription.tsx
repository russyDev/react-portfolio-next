  ...
  return (
    <>
      ...
      <div className="flex-col lg:flex-row flex gap-5 lg:gap-16 mt-16">
        <div>
          <div className="uppercase underline text-main font-medium text-lg">Born in</div>
          <Link href="" className="text-primaryDark font-semibold text-lg hover:text-orange-400">
            {user.address}
          </Link>
        </div>
        <div>
          <div className="uppercase underline text-main font-medium text-lg">Mail</div>
          <Link href="" className="text-primaryDark font-semibold text-lg hover:text-orange-400">
            {user.email}
          </Link>
        </div>
        <div>
          <div className="uppercase underline text-main font-medium text-lg">Phone</div>
          <Link href="" className="text-primaryDark font-semibold text-lg hover:text-orange-400">
            {user.phone}
          </Link>
        </div>
